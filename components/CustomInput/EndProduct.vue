<template>
  ...
  >
    <div class="pb-6">
      ...
      <div class="rounded-sm p-6 space-y-6 bg-mainBg dark:bg-darkMainBg shadow-md text-T2TextColor dark:text-darkT2TextColor">
        <div class="space-y-4">
          <!-- Controls -->
        ...
        <div class="relative bg-mainT3Bg dark:bg-darkMainT3Bg rounded p-4">
          <CustomButton
